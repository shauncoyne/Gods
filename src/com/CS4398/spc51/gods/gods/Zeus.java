...
public class Zeus extends God{
	...
	public void reward(int previousBP, int currentBP, Believer believer)
	{
		...
		case 10:  	Reward give = new GiveItem(believer.getPlayer(), "You have been good to me and my purpose");
					give.execute();
					break;
		case 15: Reward giveNext = new GiveItem(believer.getPlayer(), "You have been good to me and my purpose");
				giveNext.execute();
				break;
		case 20: Reward giveAgain = new GiveItem(believer.getPlayer(), "You have been good to me and my purpose");
				giveAgain.execute();
				break;
		case 30: Reward giveAnother = new GiveItem(believer.getPlayer(), "You have been good to me and my purpose");
				giveAnother.execute();
				break;
